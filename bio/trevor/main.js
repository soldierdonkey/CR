...
C.push(createSprite("main", UUID(), "C C0", 50-1400, 210))
C.push(createSprite("main", UUID(), "C C1", 500-1400, 220))
C.push(createSprite("main", UUID(), "C C2", 900-1400, 230))
C.push(createSprite("main", UUID(), "C C3", 900-1400, 370))
C.push(createSprite("main", UUID(), "C C4", 500-1400, 450))
C.push(createSprite("main", UUID(), "C C5", 50-1400, 350))
C.push(createSprite("main", UUID(), "C C6", 70-1400, 580))
C.push(createSprite("main", UUID(), "C C7", 950-1400, 570))